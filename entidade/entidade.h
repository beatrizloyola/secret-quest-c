...
void lista_spawnar_sala(ListaEntidades* lista, Sala* sala, Entidade** jogador, Fase* fase); //cria jogador, inimigos e itens a partir dos spawns da sala; pula fragmentos já coletados
...
void lista_atualizar(ListaEntidades* lista, Sala* sala, Entidade* jogador, float dt, int* score, EstadoJogo* estado, Fase* fase); //atualiza inimigos, cooldowns, dano por contato, coleta de item e coleta de fragmento
...
void entidade_atacar(Entidade* atacante, ListaEntidades* alvos, Sala* sala, int* score); //ativa o ataque
